...
class DevNotifyEmailData {
    ...
    public final static String contactsFile;
    ...
    public DevNotifyEmailData() throws JAXBException, AddressException, IOException {
     ...
     */
    private Address[] getContacts() throws IOException, AddressException {
